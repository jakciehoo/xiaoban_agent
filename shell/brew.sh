...
echo "
             ...
             ${tty_cyan} [308702743@qq.com] ${tty_reset}
           ['$TIME']['$macos_version']
       ${tty_cyan} https://github.com/TheRamU/ben${tty_reset}
"
#选择一个brew下载源
echo -n "${tty_green}
...
安装cask软件：brew install --cask firefox 把firefox换成你要安装的
        ...
        ${tty_underline} https://github.com/TheRamU/ben ${tty_reset}
"
